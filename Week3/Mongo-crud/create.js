...
async function main(){
    /**
     * Connection URL. Update <username>, <password>, and <your-cluster-url> to reflect your cluster.
     * See http://bit.ly/NodeDocs_lauren for more details
     */
    const url = "mongodb+srv://hyfuser:hyfuser@cluster0-7ofa4.mongodb.net/test?retryWrites=true&w=majority" ;  
    /**
